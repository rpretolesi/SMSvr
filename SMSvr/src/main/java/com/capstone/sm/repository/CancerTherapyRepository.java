...
//
@RepositoryRestResource(path = CancerTherapySvcApi.CANCER_THERAPY_STATUS_SVC_PATH)
public interface CancerTherapyRepository extends CrudRepository<CancerTherapy, Long>{
	
	public CancerTherapy findById(
